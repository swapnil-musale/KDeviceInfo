...
import com.devx.kdeviceinfo.core.BuildConfig
...
internal class AndroidInfoImpl(
    ...
    private val androidDeviceOrientation: DeviceOrientation by lazy {
        AndroidDeviceOrientation(context)
    }
    ...
    override val locale: Locale
        get() {
            val locale = LocaleManagerCompat.getSystemLocales(context).get(0)
            return Locale(
